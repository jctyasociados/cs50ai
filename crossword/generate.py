...
class CrosswordCreator():
    ...
    def select_unassigned_variable(self, assignment):
        ...
        for variable in self.crossword.variables:  # Check all the variables in the crossword
            if variable not in assignment:  # If variable is not assigned add it to potential vars with number of domain options and minimum remainig value and the number of neighbours degree.
